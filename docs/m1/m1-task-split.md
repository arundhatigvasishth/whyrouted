...
## 8. Working agreement — commits, branches, PRs, review
...
5. **What's not covered** — known gaps, follow-ups, things deferred to a later task.
6. **Review focus** — where you specifically want the reviewer to look hard.

Keep PRs small enough to review properly in one sitting — roughly one track task
group per PR, not a whole track in one go.
...
- Both people should end M1 having authored a comparable number of PRs and
  reviewed a comparable number. Track it loosely; rebalance if it drifts.
